...
### 后端/数据分析
- [x] 统计/状态转移分析模块 (完成于 2025-11-18)
  - 截止日期: 2025-11-30
  - 描述: 频率分析、随机性检验、Markov 转移矩阵
  - 模块: 分析

- [x] 任务执行性能优化 (完成于 2025-11-18)
  - 截止日期: 2025-11-28
  - 描述: 引入批处理、异步 IO，压测 jobs_worker
  - 模块: 特征工程

### 后端API
- [x] 特征/分析结果导出能力 (完成于 2025-11-18)
  - 截止日期: 2025-11-29
  - 描述: 支持 CSV/JSON 导出、批量 period 查询
  - 模块: 后端API

### 前端
- [x] 分析图表页面 (完成于 2025-11-18)
  - 截止日期: 2025-11-30
  - 描述: 显示多种分析结果、交互筛选
  - 模块: 前端

- [x] 历史数据页面 (完成于 2025-11-18)
  - 截止日期: 2025-12-02
  - 描述: 历史开奖/特征列表、筛选、导出
  - 模块: 前端

## 💡 低优先级（可延后）
- [x] 策略回测模块 (完成于 2025-11-18)
  - 截止日期: 2025-12-15
  - 描述: 策略定义、回测框架、绩效指标
  - 模块: 分析

- [x] 系统级自动化测试 (完成于 2025-11-18)
  - 截止日期: 2025-12-10
  - 描述: 为 collector/validator/worker/API 编写端到端测试
  - 模块: 测试

- [x] 用户/API 使用文档 (完成于 2025-11-18)
  - 截止日期: 2025-12-05
  - 描述: 编写部署指南与 API reference
  - 模块: 文档

## 🔄 进行中
- [x] 技术架构文档迭代 (已完成 2025-11-18)
  - 开始日期: 2025-01-XX
  - 预计完成: 2025-11-20
  - 描述: 补充任务调度、监控章节

- [x] 分析框架文档完善 (已完成 2025-11-18)
  - 开始日期: 2025-01-XX
  - 预计完成: 2025-11-20
